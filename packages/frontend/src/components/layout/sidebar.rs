    ...
    rsx! {
        nav { class: "sidebar", role: "navigation", aria_label: "Navegación principal",
            ...
            div { class: "sidebar-footer",
                ...
                a { class: "nav-item config-item", href: "/admission",
                    span { class: "icon",
                        svg { role: "presentation", view_box: "0 0 24 24",
                    ...
                    span { class: "label", "Admisiones" }
                }

                a { class: "nav-item config-item", href: "/grade-levels",
                    span { class: "icon",
                        svg { role: "presentation", view_box: "0 0 24 24",
                    ...
                    span { class: "label", "Niveles" }
                }

                a { class: "nav-item config-item", href: "/academic-years",
                    span { class: "icon",
                        svg { role: "presentation", view_box: "0 0 24 24",
                    ...
                    span { class: "label", "Años Académicos" }
                }

                a { class: "nav-item config-item", href: "/classrooms",
                    span { class: "icon",
                        svg { role: "presentation", view_box: "0 0 24 24",
                    ...
                    span { class: "label", "Salas" }
                }

                a { class: "nav-item config-item", href: "/audit",
                    span { class: "icon",
                        svg { role: "presentation", view_box: "0 0 24 24",
                            path { d: "M12 20h9" }
