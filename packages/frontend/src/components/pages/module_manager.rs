...
fn module_icon(icon: String) -> Element {
    match icon.as_str() {
        ...
        "calendar" => rsx! { rect { x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2" } line { x1: "16", y1: "2", x2: "16", y2: "6" } line { x1: "8", y1: "2", x2: "8", y2: "6" } line { x1: "3", y1: "10", x2: "21", y2: "10" } },
        "home" => rsx! { path { d: "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" } polyline { points: "9 22 9 12 15 12 15 22" } },
        "file-text" => rsx! { path { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" } polyline { points: "14 2 14 8 20 8" } line { x1: "16", y1: "13", x2: "8", y2: "13" } line { x1: "16", y1: "17", x2: "8", y2: "17" } },
